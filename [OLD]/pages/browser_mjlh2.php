...
?>
<img id="currentPage" name="currentPage" src="texts/volume<?=$curtext->volume?>/png/MJLH-full-text-<?=$curpage?>.png" style="border: 1px solid #CCCCCC; border-bottom:1px solid #EEEEEE; border-top:1px solid #EEEEEE;" />
