...
<div style="padding-bottom:5px;">
	<div style="font-size:8pt;"><a href="page.php?id=browser_mjlh&text=<?=$row->id?>"><?=$row->title?></a></div>
</div>
<?
}
...
<table width="876" border="0">
  ...
  <tr>
    ...
    <td width="475" align="center"><div class="header2"><?=$misc_text[9][$sess->lang]?></div>
