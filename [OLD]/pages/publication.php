<p> 
<?
$result=mysql_query("SELECT * FROM mhlp_texts WHERE volume='3' ORDER BY category, textorder;");
$cat=0;
...
<div style="padding-bottom:5px; font-size:8pt;">
	<div><strong><a href="page.php?id=browser_mjlh3&text=<?=$row->id?>"><?=$row->title?></a></strong></div>
...
<a href ="../page.php?id=past_vols/volume_1"><?=$misc_text[1][$sess->lang]?></a><br />
<a href ="../page.php?id=past_vols/volume_2"><?=$misc_text[2][$sess->lang]?></a>